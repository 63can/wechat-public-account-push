...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxd01f2b051ac70c58',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'a288214c29349dba0275b72f1359e799',
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '测试', year: '1988', date: '10-05',
        },
        {
          type: '节日', name: '纪念日', year: '2021', date: '11-27',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '测试', year: '1988', date: '11-13',
        },
        {
